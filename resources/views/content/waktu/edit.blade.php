            ...
            <form action="{{ route('waktu.update', $waktu->id) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="mb-3 row">
                    <div class="col-6">
                        ...
                        <input value="{{ date('Y-m-d\TH:i', strtotime(old('waktu_mulai', $waktu->waktu_mulai))) }}"
                            name="waktu_mulai" type="datetime-local"
                    ...
                    <div class="col-6">
                        ...
                        <input value="{{ date('Y-m-d\TH:i', strtotime(old('waktu_mulai', $waktu->waktu_selesai))) }}"
                            name="waktu_selesai" type="datetime-local"
